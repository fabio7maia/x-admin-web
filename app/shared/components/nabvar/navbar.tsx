...
export const Navbar: React.FC<NavbarProps> = ({ items = [], children }) => {
  ...
  return (
    <Box row className="navbar bg-neutral text-neutral-content h-20">
        ...
        <Drawer>
          <Menu
            items={[
              ...
              { label: "Shared Showcase", url: "/shared-showcase" },
            ]}
          />
        </Drawer>
      </Box>
